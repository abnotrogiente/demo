...
`;class gt{constructor(o,l){if(this.gl=o,this.copyVideo=!1,this.show=!1,o===null){alert("Unable to initialize WebGL. Your browser or machine may not support it.");return}o.clearColor(0,0,0,1),o.clear(o.COLOR_BUFFER_BIT),this.shader=new v.Shader(`
