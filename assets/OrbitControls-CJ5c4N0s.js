...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ys(){return new Xr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bs(){return new Xr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xs(),fragmentShader:`
